...
public class PlayerTest {
    ...
    public void playerCreationSuccessTest() {
        Player whitePlayer = new Player("Beth Harmon", "beth.harmon@gmail.ru", true, 2000, 20);
        Assertions.assertEquals("Beth Harmon", whitePlayer.getName());
        Assertions.assertEquals("beth.harmon@gmail.ru", whitePlayer.getEmail());
    ...
    public void playerCreationIncorrectNameTest(String name) {
        Assertions.assertThrows(IllegalArgumentException.class, () -> {
            Player whitePlayer = new Player(name, "beth.harmon@gmail.ru", true, 2000, 20);
        });
    }
    ...
    static Stream<String> emailError() {
        return Stream.of("", "    ", null, "beth.harmongmail.ru", "Beth");
    }
